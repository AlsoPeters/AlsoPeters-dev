  ...
  return (
    <>
      ...
      <div className='grid w-screen h-screen grid-cols-12 grid-rows-6 gap-4 bg-black'>
        <div className='col-span-5 col-start-1 row-span-4 row-start-1 mt-10 ml-6 text-blue-500 border-2 border-blue-500 rounded-md'>
        ...
        <div className='col-span-7 row-span-5 mt-10 mr-6 border-2 border-red-500 rounded-md'>
          <p className='p-2 text-gray-200'>
            {' '}
            My name is Kyle Ryan Garcia. I'm a web developer living in Japan.
          </p>
        </div>
